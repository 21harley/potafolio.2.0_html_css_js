const english={
    ...
    text:[
        ...
        'Close',
        'Download CV',
        'I am a self-taught programmer, student of Computer Engineering of 9 semester besides being a full stack developer Vue-Laravel and React-Express. In my free time I teach programming classes in languages like c/c++ and java as well as designing user interfaces in figma.',
        'Name',
        'Email',
...
const spanish={
    ...
    text:[
        ...
        'Cerrar',
        'Descarga CV',
        'Soy un programador autodidacta, estudiante de Ing. Informática de 9 semestre además de ser un developer full stack Vue-Laravel y React-Express. En mis tiempos libres doy clase de programación en lenguajes como c/c++ y java además de diseñar interfaces de usuario en figma.',
        'Nombre',
        'Correo',
